...
jQuery.fn.hasDataAttr = function (a) {
    ...
    }, c.breakpoint = {xs: 576, sm: 768, md: 992, lg: 1200}, c.colors = {
        primary: "#33cabb",
        secondary: "#e4eaec",
        success: "#46be8a",
        info: "#48b0f7",
    ...
    }, c.font = {body: "Roboto, sans-serif", title: "Roboto, sans-serif"};
    var f = [];
    ...
    c.isReady = function () {
        ...
        if (Array.isArray(a)) for (var b = a.length, c = 0; c < b; c++) provider.inject(a[c]); else provider.inject(a)
    }, c.init = function () {
        ...
        if ("" != b) if (void 0 === c && (c = ""), Array.isArray(b)) for (var d = 0; d < b.length; d++) a("head link:first").after(a('<link href="' + c + b[d] + '" rel="stylesheet">')); else a("head link:first").after(a('<link href="' + c + b + '" rel="stylesheet">'))
    }, c.key = function (b, d) {
    ...
    c.init = function () {
        ...
        app.ready(function () {
            ...
            }), d.observe(document.body, {childList: !0, subtree: !0, attributes: !1})
        })
        ...
        if (void 0 !== b) {
            ...
            if ("css" in d && app.loadStyle(d.css, app.dir.vendor), "js" in d) {
                var e = d.js;
                if (Array.isArray(e)) for (var h = 0; h < e.length; h++) $LAB.queueScript(e[h]); else $LAB.queueScript(e)
            }
        ...
        a.each(c.list, function (b, d) {
            if (!(f.indexOf(b) > -1) && a(c.getSelector(d.selector)).length) {
                if ("css" in d && app.loadStyle(d.css, app.dir.vendor), "js" in d) {
                    var e = d.js;
                    if (Array.isArray(e)) for (var g = 0; g < e.length; g++) $LAB.queueScript(e[g]); else $LAB.queueScript(e)
                }
        ...
        var b = app.getReadyCallbacksString(), d = [], e = {typeahead: ").typeahead("};
            ...
            if (b.indexOf(e) != -1) {
                ...
                if (!(f.indexOf(a) > -1)) {
                    if ("css" in g && app.loadStyle(g.css, app.dir.vendor), "js" in g) {
                        var h = g.js;
                        if (Array.isArray(h)) for (var i = 0; i < h.length; i++) $LAB.queueScript(h[i]); else $LAB.queueScript(h)
                    }
    ...
    provider.initCharts = function () {
        ...
        if (a.fn.sparkline) {
            var b = "rgba(51,202,185,0.5)", c = app.colors.primary, d = app.colors.danger, e = app.colors.danger;
        ...
        void 0 == !window.Chart && (a.extend(Chart.defaults.global, {
            ...
            caretSize: 8,
            cornerRadius: 2
        }), a.extend(Chart.defaults.global.elements.arc, {backgroundColor: "rgba(51,202,185,0.5)"}), a.extend(Chart.defaults.global.elements.line, {
    ...
    provider.initEditors = function () {
        ...
        a.fn.summernote && (provider.provide("summernote", function () {
            ...
            if (b = a.extend(b, app.getDataOptions(a(this))), b.toolbar) switch (b.toolbar.toLowerCase()) {
                case"slim":
                    b.toolbar = [["style", ["bold", "underline", "clear"]], ["color", ["color"]], ["para", ["ul", "ol"]], ["insert", ["link", "picture"]]];
                    break;
                case"full":
                    b.toolbar = [["para_style", ["style"]], ["style", ["bold", "italic", "underline", "clear"]], ["font", ["strikethrough", "superscript", "subscript"]], ["fontsize", ["fontname", "fontsize", "height"]], ["color", ["color"]], ["para", ["ul", "ol", "paragraph", "hr"]], ["table", ["table"]], ["insert", ["link", "picture", "video"]], ["do", ["undo", "redo"]], ["misc", ["fullscreen", "codeview", "help"]]]
            }
            a(this).summernote(b)
            ...
            var b = a(this).data("summernote-save"), c = a(this).data("callback"), d = a(b).summernote("code");
            a(b).summernote("destroy"), app.call(c, d)
        }))
    }, provider.initQuill = function () {
        void 0 !== window.Quill && provider.provide("quill", function () {
            var b = {theme: "snow"},
                c = [[{font: []}, {header: [1, 2, 3, 4, 5, 6, !1]}, {size: ["small", !1, "large", "huge"]}], ["bold", "italic", "underline", "strike"], [{color: []}, {background: []}], [{script: "sub"}, {script: "super"}], [{header: 1}, {header: 2}, "blockquote", "code-block"], [{list: "ordered"}, {list: "bullet"}, {indent: "-1"}, {indent: "+1"}], [{direction: "rtl"}, {align: []}], ["link", "image", "video"], ["clean"]];
            if (a.extend(b, app.getDataOptions(a(this))), void 0 !== b.toolbar) {
                "full" == b.toolbar.toLowerCase() && (b.modules = {toolbar: c})
            }
    ...
    provider.initEmojies = function () {
        ...
        void 0 !== window.emojione && (emojione.imageType = "svg", emojione.sprites = !0, emojione.ascii = !0, emojione.imagePathSVGSprites = app.dir.vendor + "/emojione/emojione.svg", provider.provide("emoji", function () {
            var b = a(this).html(), c = emojione.toImage(b);
            a(this).html(c)
        }))
    }
}(jQuery), function (a) {
    provider.initForms = function () {
        ...
        a.fn.selectpicker && provider.provide("selectpicker", function () {
            a(this).selectpicker({iconBase: "", tickIcon: "ti-check", style: "btn-light"})
        })
        ...
        a.fn.datepicker && (a.fn.datepicker.defaults.multidateSeparator = ", ", provider.provide("datepicker", function () {
            "INPUT" == a(this).prop("tagName") ? a(this).datepicker() : a(this).datepicker({inputs: [a(this).find("input:first"), a(this).find("input:last")]})
        }))
        ...
        a.fn.clockpicker && provider.provide("clockpicker", function () {
            a(this).clockpicker({donetext: "Done"})
        })
        ...
        void 0 !== window.noUiSlider && provider.provide("slider", function (b, c) {
            var d = {
                range: {min: Number(a(this).dataAttr("min", 0)), max: Number(a(this).dataAttr("max", 100))},
                step: 1,
        ...
        a.fn.bootstrapWizard && provider.provide("wizard", function () {
            var b = a(this), c = a(this).find(".nav-item"), d = a(this).find(".tab-pane");
            b.bootstrapWizard({
                ...
                onNext: function (a, c, e) {
                    var f = b.bootstrapWizard("currentIndex"), g = d.eq(f), a = d.eq(e),
                ...
                onFinish: function (a, e, f) {
                    var g = d.eq(f), h = g.find('[data-provide="validation"]').addBack('[data-provide="validation"]');
    ...
    provider.initUIs = function () {
        ...
        a.fn.animsition && provider.provide(".animsition", function () {
            a(this).animsition({linkElement: '[data-provide~="animsition"], .animsition-link', loadingInner: ""})
        }, !0)
            ...
            b.options.itemSelector = '[data-shuffle="item"]', b.options.sizer = '[data-shuffle="sizer"]', b.options.delimeter = ",", b.options.speed = 500, provider.provide("shuffle", function () {
                ...
                d.length && a(d).find('[data-shuffle="button"]').each(function () {
                    a(this).on("click", function () {
                        var c = a(this), d = c.hasClass("active"), f = c.data("group");
        ...
        a.fn.photoSwipe && provider.provide("photoswipe", function () {
            var b = a(this), c = a(this).dataAttr("slide-selector", "img"), d = {}, e = {
                escKey: "bool",
                loop: "bool",
                pinchToClose: "bool",
                arrowKeys: "bool",
        ...
        void 0 !== window.Swiper && provider.provide("swiper", function () {
            var b = {autoplay: 0, speed: 1e3, loop: !0, breakpoints: {480: {slidesPerView: 1}}}, c = a(this);
    ...
    provider.initMiscs = function () {
        ...
        void 0 !== window.Typed && provider.provide("typed", function () {
            var b = a(this).data("type").split("|"), c = {strings: b, typeSpeed: 50, backSpeed: 30, loop: !0};
    ...
    app.modaler = function (b) {
        var c = a.extend({}, app.defaults.modaler, b), d = function () {
    ...
    c.init = function () {
        ...
        a.load(a.data("url"), function () {
            a.find(".dock-body").perfectScrollbar({wheelPropagation: !1}), a.hasDataAttr("on-load") && b[a.data("on-load")].call(), a.hasDataAttr("always-reload") && "true" === a.data("always-reload") || a.data("url-has-loaded", "true")
        })
    }, b.dock = c
}(jQuery, window), function (a, b) {
    var c = {};
    ...
    c.init = function () {
        a(document).on("click", ".card-btn-close", function () {
            ...
            b.preventDefault();
            var c = a(this).attr("href"), d = a(this).parents(".card");
    ...
    app.initCorePlugins = function () {
        ...
        }), a('[data-provide~="popover"]').popover({container: "body"}), a(".modal-right .modal-body, .modal-left .modal-body").perfectScrollbar(), a(".scrollable").perfectScrollbar({
            wheelPropagation: !1,
            wheelSpeed: .5
        ...
        a(document).on("click", d, function () {
            ...
            a('[data-provide~="sticker"]').each(function () {
                ...
                var c = app.getTarget(a(this)), d = a(this).dataAttr("original-top"),
                    e = a(c).offset().top + a(c).height(), f = a(this).width(), g = 0;
            ...
            var b = a(this).closest("th"), c = b.closest("tr").children().index(b), d = a(this).prop("checked");
            ...
            var b = a(this).closest(".media-list"), c = a(this).prop("checked");
            ...
            var c = b.pageX, d = b.pageY, e = d - a(this).offset().top, f = c - a(this).offset().left, g = this,
                h = parseInt(f), i = parseInt(e);
            a(this).find("svg").remove(), a(this).append('<svg><circle cx="' + h + '" cy="' + i + '" r="0"></circle></svg>');
            var j = a(g).find("circle");
            j.animate({r: a(g).outerWidth()}, {
                duration: 400, step: function (a) {
                    j.attr("r", a)
                }, complete: function () {
                    j.fadeOut("fast")
                }
        ...
        a(document).on("click", ".rating-remove", function () {
            ...
            b.preventDefault();
            var c = app.getTarget(a(this)), d = app.getURL(a(this));
            ...
            var b = a(this).val(), c = a(this).closest(".lookup-fullscreen"), d = c.data("url");
